...
contextBridge.exposeInMainWorld('senyuAPI', {
  ...
  dragStart: (point?: { screenX: number; screenY: number }) => ipcRenderer.invoke('pet:drag-start', point),
  dragMove: (point?: { screenX: number; screenY: number }) => ipcRenderer.send('pet:drag-move', point),
